...
def generate_ground_truth(client_openai, model, question, context):
    system_prompt = (
        ...
        "2. DATE RANGE: The available data range is strictly from '2022-01' to '2025-12'. "
        "   - Do NOT generate questions or comparisons outside this range.\n"
        "   - If a YoY comparison is requested, ensure the prior year also falls within this 2022-01 to 2025-12 window.\n"
